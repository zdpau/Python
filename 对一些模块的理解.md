...
(3, 2)
```
### 1.1 有关reshape方法的一个知识点：Numpy中reshape函数参数-1的含义（https://blog.csdn.net/weixin_39449570/article/details/78619196）
...
### 1.2 arange(),reshape()用法：https://blog.csdn.net/chinacmt/article/details/78548420
> 具体内容见这篇就行，直接上代码一目了然
